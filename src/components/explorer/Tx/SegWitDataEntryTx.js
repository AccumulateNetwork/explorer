        ...
        <div>
            ...
            {tx ? (
                ...
                <Descriptions bordered column={1} size="middle">
                    ...
                    {tx.data.entryUrl && tx.data.entryHash ? (
                        <Descriptions.Item label={<span><nobr><IconContext.Provider value={{ className: 'react-icons' }}><Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.entry}><RiQuestionLine /></Tooltip></IconContext.Provider>Entry</nobr></span>}>
                            <Link to={'/acc/' + tx.data.entryUrl.replace("acc://", "") + "#data/" + tx.data.entryHash}><IconContext.Provider value={{ className: 'react-icons' }}><RiFileList2Line /></IconContext.Provider>{tx.data.entryUrl}#data/{tx.data.entryHash}</Link>
                        </Descriptions.Item>
                    ) :
                        null
                    }
...
export default SegWitDataEntryTx;
