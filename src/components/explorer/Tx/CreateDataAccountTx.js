...
const CreateDataAccountTx = props => {
        ...
        <div>
            ...
            {tx ? (
                ...
                <Descriptions bordered column={1} size="middle">
                    ...
                    {(tx.data && tx.data.url) ? (
                        <Descriptions.Item label={<span><nobr><IconContext.Provider value={{ className: 'react-icons' }}><Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.dataAccUrl}><RiQuestionLine /></Tooltip></IconContext.Provider>Data Account</nobr></span>}>
...
export default CreateDataAccountTx;
