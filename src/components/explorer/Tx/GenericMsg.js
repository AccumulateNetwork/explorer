                    ...
                    <Descriptions bordered column={1} size="middle">
                        ...
                        {(signature?.signer || signature?.origin) && (
                            <Descriptions.Item label={<span><nobr><IconContext.Provider value={{ className: 'react-icons' }}><Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.sigSignerUrl}><RiQuestionLine /></Tooltip></IconContext.Provider>Signer</nobr></span>}>
                                {signature.type === 'authority' && <Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.authSig}><Tag color="gray">Authority</Tag></Tooltip>}
                                {signature.vote === 'accept' && <Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.sigAccept}><Tag color="green">Acceptance</Tag></Tooltip>}
                                {signature.vote === 'reject' && <Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.sigReject}><Tag color="red">Rejection</Tag></Tooltip>}
                                {signature.vote === 'abstain' && <Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.sigAbstain}><Tag color="yellow">Abstention</Tag></Tooltip>}
                                <Link to={'/acc/' + (signature.signer || signature.origin).replace("acc://", "")}><IconContext.Provider value={{ className: 'react-icons' }}><RiAccountCircleLine /></IconContext.Provider>{(signature.signer || signature.origin)}</Link>
                            </Descriptions.Item>
                        )}

                        {signature?.publicKey && (
                            <Descriptions.Item label={<span><nobr><IconContext.Provider value={{ className: 'react-icons' }}><Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.publicKey}><RiQuestionLine /></Tooltip></IconContext.Provider>Public Key</nobr></span>}>
                                <Key publicKey={signature.publicKey} type={signature.type} />
                            </Descriptions.Item>
                        )}

                        {props.data.message?.txID && (
                            <Descriptions.Item label={<span><nobr><IconContext.Provider value={{ className: 'react-icons' }}><Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.txHash}><RiQuestionLine /></Tooltip></IconContext.Provider>Transaction</nobr></span>}>
                                <Link to={'/acc/' + props.data.message.txID.replace("acc://", "")}><IconContext.Provider value={{ className: 'react-icons' }}><RiExchangeLine /></IconContext.Provider>{props.data.message.txID}</Link>
                            </Descriptions.Item>
                        )}
                        ...
                        {signature?.cause && (
                            <Descriptions.Item label={<span><nobr><IconContext.Provider value={{ className: 'react-icons' }}><Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.sigCause}><RiQuestionLine /></Tooltip></IconContext.Provider>Cause</nobr></span>}>
                                <Link to={'/acc/' + signature.cause.replace("acc://", "")}><IconContext.Provider value={{ className: 'react-icons' }}><RiExchangeLine /></IconContext.Provider>{signature.cause}</Link>
                            </Descriptions.Item>
                        )}
                        ...
                        {props.data.produced?.records?.length > 0 && (
                            <Descriptions.Item className={'align-top has-list'} label={<span><nobr><IconContext.Provider value={{ className: 'react-icons' }}><Tooltip overlayClassName="explorer-tooltip" title={tooltipDescs.produced}><RiQuestionLine /></Tooltip></IconContext.Provider>Produced</nobr></span>}>
                                ...
                                {props.data.produced.records.length > 5 && !showAllProduced && (
                                    <List.Item key={"more"}><Button onClick={e => setShowAllProduced(true) } >+{props.data.produced.records.length - 5} more</Button></List.Item>
                                )}
                            </Descriptions.Item>
                        )}
